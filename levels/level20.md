...
## 🎯 Objective
##### There is a setuid binary in the home directory that does the following: it makes a connection to localhost on a port you specify, reads a password from stdin, and if the password is correct, it transmits the password for the next level.
